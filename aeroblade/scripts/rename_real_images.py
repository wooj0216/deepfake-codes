...
def parse_args():
    ...
    parser.add_argument(
        "--metadata-path", type=Path, default="/media/data3/woojeong/DEEPFAKE/aeroblade/data/raw/real/real_metadata.parquet"
    )
    parser.add_argument("--image-dir", type=Path, default="tmp/laion/00000")
    parser.add_argument("--output-dir", type=Path, default="/media/data3/woojeong/DEEPFAKE/aeroblade/data/raw/real")
